...
tests: trans-no_nested_borrows trans-paper \
	...
	trans-loops \
	trans-array trans-binpow # TODO: generalize to all backends
...
trans-binpow: OPTIONS += -no-state
trans-binpow: SUBDIR := misc
tfstar-binpow: OPTIONS += -decreases-clauses -template-clauses
tcoq-binpow: OPTIONS += -use-fuel -no-split-files
tlean-binpow: SUBDIR :=
thol4-binpow: SUBDIR := misc-loops
